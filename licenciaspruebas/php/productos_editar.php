...
try {
    ...
    $query1 = "UPDATE productos SET codigo_1='" . $codigo_1 . "', nombre_producto='" . $nombre_producto . "', descripcion='" . $descripcion . "', plataforma='" . $plataforma . "', link_descarga='" . $link_descarga . "', precio_venta='" . $precio_venta . "' WHERE id_producto='".$id_seleccionado."'";
