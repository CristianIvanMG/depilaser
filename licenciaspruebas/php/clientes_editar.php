...
try {
    ...
    $query0 = "SELECT codigo_cliente FROM clientes WHERE codigo_cliente='".$codigo_cliente."' AND id_cliente!='".$id_seleccionado."' AND eliminado='0';";
    ...
    $query1 = "UPDATE clientes SET codigo_cliente='" . $codigo_cliente . "', empresa='" . $empresa . "', nombres='" . $nombres . "', apellidos='" . $apellidos . "', telefono_1='" . $telefono . "', email='" . $email . "', direccion='".$calle."', colonia='".$colonia."', cp='".$cp."', pais='".$pais."' WHERE id_cliente='".$id_seleccionado."';";
