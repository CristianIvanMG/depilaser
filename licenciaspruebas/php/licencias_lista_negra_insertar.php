...
try {
    ...
    $query0 = "SELECT id_dispositivo_activado FROM dispositivos_activados WHERE id_dispositivo_activado='".$id_seleccionado."' AND lista_negra='1';";
	$consulta = $conexion->query($query0);
	if ($consulta->num_rows > 0)
	{
        $datos[] = array(
            "status" => "warning",
            "mensaje" => "La licencia seleccionada ya fue enviada a la lista negra anteriormente.",
            "color" => "#739E73",
    ...
    $query1 = "UPDATE dispositivos_activados SET lista_negra='1' WHERE id_dispositivo_activado='".$id_seleccionado."'";
